...
const Home = () => {
  ...
  const videoArray = [video1, video2, video3, video4, video5, video6, video7, video8, video9];
      ...
      {user ? (
        ...
        <div class="wrapper">
          ...
          <div class="content">
            ...
            <div class="buttons">
            <span class="login"><a class="login" href="/login"></a></span>
            <span class="register"><a class="register" href="/register"></a></span>
